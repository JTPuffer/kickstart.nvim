...
What is Kickstart?
  ...
  Kickstart.nvim is a starting point for your own configuration.
    ...
    After understanding a bit more about Lua, you can use `:help lua-guide` as
    a
...
vim.opt.smartindent = true -- Smarter autoindenting for C-style files
...
--sets the insert mode arrow key jumping so it works

vim.api.nvim_set_keymap('i', '<C-Right>', '<End>', { noremap = true, silent = true })

vim.api.nvim_set_keymap('i', '<C-Left>', '<C-o>b', { noremap = true, silent = true })
-- movemnet of line keys
...
-- adds ctrl backspace to the insert mode
vim.keymap.set('i', '<C-BS>', '<C-w>', { desc = 'Delete previous word' })

vim.keymap.set('i', '<C-H>', '<C-w>', { desc = 'Delete previous word (Ctrl-H fallback)' })
-- Diagnostic keymaps
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>l', '<cmd>NvimTreeToggle<CR>', { desc = 'Toggle NvimTree' })
    end,
  },
      ...
      local servers = {
        clangd = {
          cmd = {
            ...
            '--clang-tidy-checks=*', -- enable all checks
